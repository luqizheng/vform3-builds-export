...
export const addZhCNLabel = (prop, value) => {
  langResources['zh-CN'].extension.widgetLabel[prop] = value
}
export const addZhCNSetting = (prop, value) => {
  langResources['zh-CN'].setting.widgetLabel[prop] = value
}
export const addENUSLabel = (prop, value) => {
  langResources['en-US'].extension.widgetLabel[prop] = value
}
export const addENUSSetting = (prop, value) => {
  langResources['en-US'].setting.widgetLabel[prop] = value
}
export default {
  methods: {
    i18nt(key) {
